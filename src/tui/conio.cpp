...
/** \brief Returns a string that contains the escape sequence to 
 * enter the terminal's Alternate Screen buffer.
 * \return A string containing the entire escape sequence to be output
 *      to the terminal to enter the Alternate Screen buffer.
 */
std::string enterAltScreen( ) {
    std::ostringstream strm;
    strm << CSI << "?1049h";
    return strm.str();
}
 ...
 * \return A string containing the entire escape sequence to be output
 *      to the terminal to leave the Alternate Screen buffer.
 */
 ...
 * show the cursor.
 * \return A string containing the entire escape sequence to be output
 *      to the terminal to show the cursor.
 */
 ...
 * hide the cursor.
 * \return A string containing the entire escape sequence to be output
 *      to the terminal to hide the cursor.
 */
